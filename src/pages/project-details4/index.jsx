...
import ProjectIntro4 from "../../components/Project-Intro4";
    ...
    <MainLayout>
      <PageHeader
        ...
        fullPath={[
          ...
          { id: 3, name: "детали проекта", url: "/project-details4" },
        ]}
        ...
        <div className="justified-gallery">
          <div className="row">
            <a className="class1 col-lg-4 col-xl-3 col-md-12">
              <img alt="" src="/assets/img/portfolio/project5/1.jpg" />
            </a>
            <a className="class1 col-lg-4 col-xl-3 col-md-6">
              <img alt="" src="/assets/img/portfolio/project5/2.jpg" />
            </a>
            <a className="class1 col-lg-4 col-xl-3 col-md-6">
              <img alt="" src="/assets/img/portfolio/project5/3.jpg" />
            </a>
            <a className="class1 col-lg-4 col-xl-3 col-md-12">
              <img alt="" src="/assets/img/portfolio/project5/4.jpg" />
            </a>
          </div>
        </div>
      </section>
