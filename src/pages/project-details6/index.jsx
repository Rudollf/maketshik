...
import ProjectIntro6 from "../../components/Project-Intro6";
...
const ProjectDetails6 = () => {
  ...
  return (
    <MainLayout>
      <PageHeader
        title="«Металлоконструкция Akfa»"
        fullPath={[
          { id: 1, name: "главная", url: "/" },
          { id: 2, name: "портфолио", url: "/work1" },
          { id: 3, name: "детали проекта", url: "/project-details6" },
        ]}
        ...
        <div className="justified-gallery">
          <div className="row">
            <a className="class1 col-lg-4 col-xl-3 col-md-12">
              <img alt="" src="/assets/img/portfolio/project7/1.jpg" />
            </a>
            <a className="class1 col-lg-4 col-xl-3 col-md-6">
              <img alt="" src="/assets/img/portfolio/project7/2.jpg" />
            </a>
            <a className="class1 col-lg-4 col-xl-3 col-md-6">
              <img alt="" src="/assets/img/portfolio/project7/3.jpg" />
            </a>
            <a className="class1 col-lg-4 col-xl-3 col-md-12">
              <img alt="" src="/assets/img/portfolio/project7/4.jpg" />
            </a>
          </div>
        </div>
      </section>
      ...
      <a className="padding-left class1">
        <img alt="" src="/assets/img/portfolio/project7/5.jpg" />
      </a>
