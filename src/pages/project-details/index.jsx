...
import ProjectIntro1 from "../../components/Project-Intro1";
    ...
    <MainLayout>
      <PageHeader
        ...
        fullPath={[
          ...
          { id: 3, name: "детали проекта", url: "/project-details" },
        ]}
      ...
      <section className="projdtal">
        <div className="justified-gallery">
          <div className="row">
            ...
            <a className="class1 col-lg-4 col-xl-3 col-md-12">
              <img alt="" src="/assets/img/portfolio/project2/4.jpg" />
            </a>
          </div>
        </div>
      </section>
      ...
      <a className="padding-left class1">
        <img alt="" src="/assets/img/portfolio/project2/5.jpg" />
      </a>
