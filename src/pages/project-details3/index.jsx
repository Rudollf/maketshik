...
import ProjectIntro3 from "../../components/Project-Intro3";
    ...
    <MainLayout>
      <PageHeader
        ...
        fullPath={[
          ...
          { id: 3, name: "детали проекта", url: "/project-details3" },
        ]}
        ...
        <div className="justified-gallery">
          <div className="row">
            ...
            <a className="class1 col-lg-4 col-xl-3 col-md-6">
              <img alt="" src="/assets/img/portfolio/project4/2.jpg" />
            </a>
            <a className="class1 col-lg-4 col-xl-3 col-md-6">
              <img alt="" src="/assets/img/portfolio/project4/4.jpg" />
            </a>
            <a className="class1 col-lg-4 col-xl-3 col-md-12">
              <img alt="" src="/assets/img/portfolio/project4/3.jpg" />
            </a>
          </div>
        </div>
      </section>
      ...
      <a className="padding-left class1">
        <img alt="" src="/assets/img/portfolio/project4/5.jpg" />
      </a>
