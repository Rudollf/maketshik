...
import ProjectIntro2 from "../../components/Project-Intro2";
...
const ProjectDetails2 = () => {
  ...
  return (
    <MainLayout>
      <PageHeader
        title="ЖК «Osiyo Stroy»"
        fullPath={[
          { id: 1, name: "главная", url: "/" },
          { id: 2, name: "портфолио", url: "/work1" },
          { id: 3, name: "детали проекта", url: "/project-details2" },
        ]}
        ...
        <div className="justified-gallery">
          <div className="row">
            ...
            <a className="class1 col-lg-4 col-xl-3 col-md-6">
              <img alt="" src="/assets/img/portfolio/project3/2.jpg" />
            </a>
            <a className="class1 col-lg-4 col-xl-3 col-md-6">
              <img alt="" src="/assets/img/portfolio/project3/3.jpg" />
            </a>
            <a className="class1 col-lg-4 col-xl-3 col-md-12">
              <img alt="" src="/assets/img/portfolio/project3/4.jpg" />
            </a>
          </div>
        </div>
      </section>
      ...
      <a className="padding-left class1">
        <img alt="" src="/assets/img/portfolio/project3/5.jpg" />
      </a>
